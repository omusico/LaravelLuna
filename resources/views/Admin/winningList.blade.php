            ...
            @if(env('SITE_TYPE','')=='gaopin')
                <div style="display: inline-block;">
                    <ul class="nav navbar-nav" role="tablist">
                        ...
                        <li role="presentation"><a href="/winningList?bettingType=ssc">时时彩投注记录</a></li>
                        <li role="presentation"><a href="/winningList?bettingType=6he">六合彩投注记录</a></li>
                    </ul>
                </div>
                <br>
                <input type="hidden" id="bettingType" value="{{$bettingType}}">
            @endif
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function Search() {
            url = "winningList?userName=" + $("#userName").val() + "&starttime=" + $("#starttime").val() + "&bettingType=" + $("#bettingType").val() + "&endtime=" + $("#endtime").val();
