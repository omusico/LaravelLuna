...
$_SERVER['HTTP_ORIGIN'] = $level['returnurl'];
$_SERVER['HTTP_HOST'] = $level['returnurl'];
$merchant_code = $level['id'];//$_POST['merchant_code'];
...
$return_url =$level['returnurl']."/zfReturn_Url";//$_POST['return_url'];
